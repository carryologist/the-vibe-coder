---
title: "Day 5: Comments, Open Source, and the Whisper Mix-Up"
date: '2026-04-18'
description: >-
  Adding a commenting system with Giscus, cleaning up the repo for public
  release, researching Whisper vs Wispr, and closing out week one — all from
  a cabana in Cabo.
tags:
  - meta
  - ai
...
I set myself a challenge: could I build a working personal blog in five days, spending 60–90 minutes each day, using nothing but my iPhone, all while lounging in a cabana in Cabo?
...
Making a repo public when you're the CEO of a software development company isn't something you do casually. If there's a hardcoded API key or a GPS-tagged photo buried in the history, you've got a problem. So before flipping the switch, I had the agent run a full security assessment.
...
I'm the CEO of Coder. Software engineers are going to look at this repo. It needed to be something a developer would respect — well-organized, no dead code, no leftover boilerplate from `create-next-app`.
...
They just happen to have almost identical names.

And here's the punchline: **there's nothing to integrate.** Wispr Flow already works with any text field on any website — including our admin pages. If I install the app, I can use it to dictate into the blog's transcript editor right now. No code changes needed.
...
The blog is live and functional. It has voice recording, AI generation, inline editing, analytics, RSS, syndication, and comments. It's deployed on Vercel, developed in Coder, and the source is open for anyone to see.

But this was always just the foundation. I've got my eyes on a bigger project — one that uses everything I've learned about AI-assisted development, mobile-first workflows, and building in public. Stay tuned.
